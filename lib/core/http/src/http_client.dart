...
class HttpClient {
  static HttpClient get defaultClient =>
      getx.Get.find<HttpClient>(tag: defaultClientTag);

  static const defaultClientTag = 'dio.http.default';
  static const imageClientTag = 'dio.http.uploadImage';
  late AppDio _dio;
  ...
  Future<HttpResponse> uploadImage(String uri, Uint8List image,
    ...
    FormData formData = FormData.fromMap(
        {"file": await MultipartFile.fromBytes(image, filename: "iamge.png")});
    try {
      var response = await _dio.post(
        uri,
        data: formData,
